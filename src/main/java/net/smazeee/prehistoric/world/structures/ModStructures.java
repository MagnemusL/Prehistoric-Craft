package net.smazeee.prehistoric.world.structures;
...
public class ModStructures {
    ...
    /**
     * We are using the Deferred Registry system to registe our structure as this is the preferred way on Forge.
    ...
    public static final DeferredRegister<StructureFeature<?>> DEFERRED_REGISTRY_STRUCTURE =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, PrehistoricCraft.MOD_ID);
    ...
    public static final RegistryObject<StructureFeature<?>> ARCHAEOPTERIS_TREES = DEFERRED_REGISTRY_STRUCTURE.register("archaeopteris_trees", ArchaeopterisTrees::new);
