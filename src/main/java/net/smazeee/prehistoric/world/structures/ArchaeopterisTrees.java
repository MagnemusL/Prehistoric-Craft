...
public class ArchaeopterisTrees extends StructureFeature<JigsawConfiguration> {
    ...
    public ArchaeopterisTrees() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, ArchaeopterisTrees::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            PrehistoricCraft.LOGGER.log(Level.DEBUG, "Archaeopteris Trees at {}", blockpos);
        }
